=== Events Manager ESS ===
Contributors: essfeed, netweblogic
...
= 0.983 =
* place the ability to aggregate events without location.
* place the ability to predefine if the aggregated events will be placed as 'draft' or automatically published.
* fix a bug while adding the categories in the ESS feed creation.
* fix a bug that duplicated the location if the zip of the state wasn't available in the feed.
